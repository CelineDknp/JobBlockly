...
Blockly.Blocks['custom_if_bee'] = {
  /**
     * Block for 'if' conditional if there is nectar or honey in a flower.
     * @this Blockly.Block
     */
  init: function() {
    this.appendDummyInput()
...
Blockly.Blocks['custom_while_bee'] = {
  /**
     * Block for while loop if there is nectar or honey
     * @this Blockly.Block
     */
  init: function() {
    this.appendDummyInput()
 ...
 this.setTooltip("Execute le code tant que le personnage est sur une fleur avec du nectar");
 this.setHelpUrl("");
  }
};

Blockly.JavaScript['custom_while_bee'] = function(block) {
  var dropdown_kind = block.getFieldValue('KIND');
  var dropdown_comp = block.getFieldValue('COMP');
  var number_number = block.getFieldValue('NUMBER');
  var statements_stat = Blockly.JavaScript.statementToCode(block, 'STAT');
  var code = 'while('+dropdown_kind+'() '+dropdown_comp+' '+number_number+'){\n'+statements_stat+"}\n";
  return code;
};

Blockly.Python['custom_while_bee'] = function(block) {
  var dropdown_kind = block.getFieldValue('KIND');
  var dropdown_comp = block.getFieldValue('COMP');
  var number_number = block.getFieldValue('NUMBER');
  var statements_stat = Blockly.Python.statementToCode(block, 'STAT');
...
Blockly.Blocks['custom_bee_if_else'] = {
  /**
     * Block for 'if/else' conditional if there is nectar or honey in a flower.
     * @this Blockly.Block
     */
...
Blockly.Blocks['custom_be_if_on'] = {
  /**
     * Block for 'if' conditional if the character is on a flower or honey.
     * @this Blockly.Block
     */
...
Blockly.Blocks['maze_2nectar'] = {
    /**
     * Block for collecting 2 nectars
     */
    init: function() {
        this.setColour(184);
