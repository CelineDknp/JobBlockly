...
for flowers in MAP_CELLS["purpleFlower"]: # Add the random value to the purple flowers
    val = random.randrange(0, 2)
    flowers["value"] = val
    flowers["remainingValue"] = val
for flowers in MAP_CELLS["redFlower"]:
    flowers["remainingValue"] = flowers["value"]
for honey in MAP_CELLS["honey"]:
    honey["remainingValue"] = honey["value"]
